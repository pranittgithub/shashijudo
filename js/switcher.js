...
jQuery( document ).ready(function() {
    ...
    jQuery(".skin-1").on('click', function(){
		...
		jQuery(".header-style-2 .logo-header-inner img").attr("src", "images/logo-1-light.png");
    ...
    jQuery(".skin-2").on('click', function(){
		...
		jQuery(".header-style-2 .logo-header-inner img").attr("src", "images/logo-2-light.png");
    ...
    jQuery(".skin-3").on('click', function(){
		...
		jQuery(".header-style-2 .logo-header-inner img").attr("src", "images/logo-3-light.png");
    ...
    jQuery(".skin-4").on('click', function(){
		...
		jQuery(".header-style-2 .logo-header-inner img").attr("src", "images/logo-4-light.png");
    ...
    jQuery(".skin-5").on('click', function(){
		...
		jQuery(".header-style-2 .logo-header-inner img").attr("src", "images/logo-5-light.png");
    ...
    jQuery(".skin-6").on('click', function(){
		...
		jQuery(".header-style-2 .logo-header-inner img").attr("src", "images/logo-6-light.png");
    ...
    jQuery(".skin-7").on('click', function(){
		...
		jQuery(".header-style-2 .logo-header-inner img").attr("src", "images/logo-7-light.png");
    ...
    jQuery(".skin-8").on('click', function(){
		...
		jQuery(".header-style-2 .logo-header-inner img").attr("src", "images/logo-8-light.png");
    ...
    jQuery(".skin-9").on('click', function(){
		...
		jQuery(".header-style-2 .logo-header-inner img").attr("src", "images/logo-9-light.png");
    ...
    jQuery(".skin-10").on('click', function(){
		...
		jQuery(".header-style-2 .logo-header-inner img").attr("src", "images/logo-10-light.png");
    ...
    jQuery(".skin-11").on('click', function(){
		...
		jQuery(".header-style-2 .logo-header-inner img").attr("src", "images/logo-11-light.png");
    ...
    jQuery(".skin-12").on('click', function(){
		...
		jQuery(".header-style-2 .logo-header-inner img").attr("src", "images/logo-12-light.png");
